...
class SearchAdapter(var context: Context) :
    ...
    ListAdapter<ResultModel, SearchAdapter.SearchAdapterViewHolder>(
    ...
    open class SearchAdapterViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onBindViewHolder(
        holder: SearchAdapterViewHolder,
        position: Int
    ) {
